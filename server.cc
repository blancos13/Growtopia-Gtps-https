...
int main(void) {
  std::cout << "[PREMIUM] Premium Version (Support Custom items + Anti ddos) for Sale 10 Dls Dm - Altanb#3535 " << std::endl;
  std::cout << "[INFO] Altanb - Http Official Server https://discord.gg/vyJDnqTFHc" << std::endl;
